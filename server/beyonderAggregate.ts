/**
 * Aggregation for /api/beyonder-stats, shared between the Vercel function
 * (api/beyonder-stats.ts) and the dev middleware in vite.config.ts.
 *
 * Lives outside api/ because vite-plugin-vercel turns EVERY api/*.ts file
 * into a routable serverless function — underscore prefixes included.
 *
