/*
 * English source strings. This is the reference tree: every other locale
 * mirrors its key shape, and t() falls back to these keys when a
...
export const en = {
    ...
    pathwaysPage: {
        ...
        dataDisclaimer: "Details may differ slightly from the current game version",
        searchLabel: "Search the archive",
        clearSearch: "Clear search",
        groupStandard: "Standard Pathways",
        groupBoons: "Boons",
    },
    ...
    ascensionPage: {
        ...
        retry: "Consult again",
        seatWord: {one: "seat", few: "seats", many: "seats"},
    },
