...
const translations = {
    en: {
        ...
        // Linear Journey Guide
        guide: {
            riteLabel: "The Rite",
            savedLocally: "Saved locally",
            savedNote: "Return any time — your rite waits.",
            tapToJump: "← tap to jump",
            chap1Label: "Awakening",
            chap2Label: "Pathway",
            chap3Label: "Gateway & Join",
            chap4Label: "Verify",
            chap5Label: "Covenant",
            chap6Label: "Companion Mod",
            chap7Label: "Completion",
            chap1No: "CHAPTER I",
            chap1Title: "The Fog calls. Will you answer?",
            chap1Lede: "Six short rites stand between you and the server. Together they take about four minutes. Your progress saves as you go — close the tab and the rite remembers.",
            beginRite: "Begin the rite ↓",
            skipToEnd: "I've been here before — skip to end",
            welcomeBack: '"welcome back, Believer"',
            chap2No: "CHAPTER II · PATHWAY",
            chap2Title: "Which sequence calls to you?",
            chap2Lede: "Three questions decide your starter pathway. Cosmetic only — it flavors your welcome kit and the final sigil. You can change it later.",
            ...
            chap3No: "CHAPTER III",
            chap3Title: "Cross the gateway",
            chap3Lede: "The address below is your threshold. Copy it, then open Minecraft and add it as a new server.",
            ...
            chap3Check: "Gateway copied & server added",
            chap4No: "CHAPTER IV",
            chap4Title: "Prove your name",
            chap4Lede: "Visit your profile page to link your Discord account and receive a verification code. Then enter it in-game to bind your character.",
            verifyRiteTitle: "Verification rite · 4 steps",
            ...
            chap4Check: "Verified in-game",
            chap5No: "CHAPTER V",
            chap5Title: "The Covenant & the World",
            chap5Lede: "Two short things before you wander: four covenant rules and a breath of lore so your surroundings make sense from the first step.",
            covenantTitle: "The Covenant",
            ...
            chap5Check: "Covenant read",
            chap6No: "CHAPTER VI · OPTIONAL",
            chap6Title: "Bind the Companion",
            chap6Lede: "The COI Client is an optional mod that brings server-specific gameplay to life. Strongly recommended, never required.",
            ...
            chap6Check: "Companion reviewed (optional)",
            sealNo: "SEAL OF COMPLETION",
            sealTitle: "The rite is finished.",
            sealLede: "Your sigil has been inscribed. Share it, save it, or simply return to the gateway.",
            believerLabel: "BELIEVER",
            pathwayLabel: "PATHWAY",
            initiatedLabel: "Initiated",
            returnGateway: "Return to gateway",
            resetProgress: "Reset progress",
            faqTitle: "If the rite falters — FAQ",
            ...
            faq4Q: "Lost my progress in this guide",
            faq4A: "Progress is stored locally per-browser. Use the rail on the left to jump back in; nothing is lost server-side.",
    ...
    uk: {
        ...
        guide: {
            ...
            savedNote: "Повертайся будь-коли — ритуал чекає.",
            tapToJump: "← натисни для переходу",
            chap1Label: "Пробудження",
            chap2Label: "Шлях",
            chap3Label: "Портал та Вхід",
            chap4Label: "Верифікація",
            chap5Label: "Ковенант",
            chap6Label: "Компаньйон",
            chap7Label: "Завершення",
            chap1No: "РОЗДІЛ I",
            chap1Title: "Туман кличе. Ти відповіси?",
            chap1Lede: "Шість коротких ритуалів відділяють тебе від сервера. Разом вони займуть близько чотирьох хвилин. Прогрес зберігається — закрий вкладку, і ритуал тебе пам'ятає.",
            beginRite: "Почати ритуал ↓",
            skipToEnd: "Я вже тут бував — перейти до кінця",
            welcomeBack: '"ласкаво просимо назад, Вірянине"',
            chap2No: "РОЗДІЛ II · ШЛЯХ",
            chap2Title: "Яка послідовність кличе тебе?",
            chap2Lede: "Три питання визначать твій стартовий шлях. Лише косметика — впливає на привітальний набір та фінальну печатку. Пізніше можна змінити.",
            ...
            chap3No: "РОЗДІЛ III",
            chap3Title: "Перейди через портал",
            chap3Lede: "Адреса нижче — твій поріг. Скопіюй її, відкрий Minecraft і додай як новий сервер.",
            ...
            chap3Check: "Адресу скопійовано, сервер додано",
            chap4No: "РОЗДІЛ IV",
            chap4Title: "Підтверди своє ім'я",
            chap4Lede: "Відвідай сторінку профілю, щоб прив'язати Discord та отримати код верифікації. Потім введи його в грі.",
            verifyRiteTitle: "Ритуал верифікації · 4 кроки",
            ...
            chap4Check: "Верифіковано в грі",
            chap5No: "РОЗДІЛ V",
            chap5Title: "Ковенант та Світ",
            chap5Lede: "Дві короткі речі перш ніж блукати: чотири правила ковенанту та ковток лору для розуміння оточення.",
            covenantTitle: "Ковенант",
            ...
            chap5Check: "Ковенант прочитано",
            chap6No: "РОЗДІЛ VI · ОПЦІОНАЛЬНО",
            chap6Title: "Прив'яжи Компаньйона",
            chap6Lede: "COI Client — опціональний мод, що оживляє серверний геймплей. Настійно рекомендований, але ніколи не обов'язковий.",
            ...
            chap6Check: "Компаньйон переглянуто (опціонально)",
            sealNo: "ПЕЧАТКА ЗАВЕРШЕННЯ",
            sealTitle: "Ритуал завершено.",
            sealLede: "Твою печатку вписано. Поділись нею, збережи або просто повернись до порталу.",
            believerLabel: "ВІРЯНИН",
            pathwayLabel: "ШЛЯХ",
            initiatedLabel: "Ініційовано",
            returnGateway: "Повернутись до порталу",
            resetProgress: "Скинути прогрес",
            faqTitle: "Якщо ритуал дає збій — FAQ",
            ...
            faq4Q: "Втратив прогрес у цьому гайді",
            faq4A: "Прогрес зберігається локально в браузері. Використовуй рейку зліва для переходу; на сервері нічого не втрачено.",
