...
const translations = {
  en: {
    ...
    firstStepsDescription: "Join the server at play.mysterria.gg and begin your journey into the world of mysteries.",
  ...
  uk: {
    ...
    firstStepsDescription: "Приєднуйтесь до сервера за адресою play.mysterria.gg і почніть свою подорож у світ таємниць.",
