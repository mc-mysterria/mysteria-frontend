...
const translations = {
  en: {
    ...
    home: {
      ...
      step1Description: "Start Minecraft Java Edition (version 1.21.6)",
    ...
    serverIP: "Server IP",
    serverAddress: "en.mysterria.net",
    ...
    firstStepsDescription: "Join the server at en.mysterria.net and begin your journey into the world of mysteries.",
  ...
  uk: {
    ...
    home: {
      ...
      step1Description: "Запустіть Minecraft Java Edition (версія 1.21.6)",
    ...
    serverIP: "IP Сервера",
    serverAddress: "uk.mysterria.net",
    ...
    firstStepsDescription: "Приєднуйтесь до сервера за адресою uk.mysterria.net і почніть свою подорож у світ таємниць.",
